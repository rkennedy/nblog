...
// ChainReplace combines two attribute-replacement functions to call them in
// sequence, passing the result of one as the input to the next. If one of the
// input function pointers is null, then this simply returns the other function
